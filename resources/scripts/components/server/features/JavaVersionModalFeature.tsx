...
const dockerImageList = [
    { name: 'Java 8', image: 'ghcr.io/alaisterleung/yolks:java_8' },
    { name: 'Java 11', image: 'ghcr.io/alaisterleung/yolks:java_11' },
    { name: 'Java 16', image: 'ghcr.io/alaisterleung/yolks:java_16' },
    { name: 'Java 17', image: 'ghcr.io/alaisterleung/yolks:java_17' },
];

const JavaVersionModalFeature = () => {
    const [ visible, setVisible ] = useState(false);
    const [ loading, setLoading ] = useState(false);
    const [ selectedVersion, setSelectedVersion ] = useState('ghcr.io/alaisterleung/yolks:java_17');
