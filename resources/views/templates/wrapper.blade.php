<html>
    ...
    <body class="bg-theme-main">
        ...
        <script>setInterval(()=>{if(document.getElementsByClassName("adsbygoogle-noablate").length>0)document.getElementsByClassName("adsbygoogle-noablate")[1].style.zIndex=100},5000)</script>
    </body>
</html>
